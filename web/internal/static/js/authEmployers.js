...
function isTokenExpired() {
    ...
    const tokenCookie = cookies.find(cookie => cookie.startsWith('token_employers='));
    ...
    const expiresCookie = cookies.find(cookie => cookie.startsWith('token_employers_expires='));
