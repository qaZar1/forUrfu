...
// PostApiRatingsAddRating operation middleware
func (siw *ServerInterfaceWrapper) PostApiRatingsAddRating(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PostApiRatingsAddRating(w, r)
	}))
...
// GetApiRatingsUsername operation middleware
func (siw *ServerInterfaceWrapper) GetApiRatingsUsername(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetApiRatingsUsername(w, r, username)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/ratings/addRating", wrapper.PostApiRatingsAddRating)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/ratings/{username}", wrapper.GetApiRatingsUsername)
	})
